    ...
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog onClose={onClose} className="fixed inset-0 z-50 overflow-y-auto">
        <div className="flex min-h-screen items-center justify-center p-4 text-center">
          ...
          >
            <Card className="relative w-full max-w-lg overflow-hidden bg-gray-900 border-gray-700">
                    ...
                    <div className="flex items-start space-x-3 p-4 bg-blue-900/20 border border-blue-700 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-300 mt-1">
                          This transaction will be processed on the Sui blockchain. Your domain will be minted as an NFT
                          and metadata will be stored on IPFS via Pinata for permanent availability.
                        </p>
                      </div>
                    </div>
                  </div>
